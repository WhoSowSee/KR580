...
fn dialog_starts_on_general_category() {
    let dialog = SettingsDialog::new(Lang::Ru, SpeedTier::Medium);
...
fn search_query_strips_surrounding_whitespace() {
    let mut dialog = SettingsDialog::new(Lang::Ru, SpeedTier::Medium);
...
fn live_speed_change_updates_active_tier_immediately() {
    ...
    app.settings_dialog = Some(SettingsDialog::new(app.lang, app.default_speed));
