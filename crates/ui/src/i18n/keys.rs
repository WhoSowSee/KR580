...
scalar_keys! {
    ...
    ImportFileLabel, ImportNoTargets, ImportSheetLabel, ImportSectionLabel,
    ImportBrowseTooltip, ImportDropPrompt, ImportDropOr, ImportSupportedFormats,
    ...
    SettingsMemoryOperandHighlightingHint, SettingsShowFileNameLabel, SettingsShowFileNameHint,
    SettingsFloppyImageLabel, SettingsFloppyImageHint,
