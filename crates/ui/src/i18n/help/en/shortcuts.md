...
Letter shortcuts use the physical QWERTY key, so English and Russian layouts are equivalent: E/У opens the opcode picker, Ctrl+S/Ctrl+Ы saves, Ctrl+M/Ctrl+Ь opens the monitor.
...
- Windows: Ctrl+M (Monitor), Ctrl+, (Settings), Ctrl+H/F1 (Help), Esc (close/clear focus)
