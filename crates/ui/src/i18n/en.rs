...
pub(super) fn translate(key: Key) -> &'static str {
    ...
    match key {
        ...
        Key::ChangelogAllVersions => "All releases",
        ...
        Key::ImportDropPrompt => "Drop a file here",
        Key::ImportDropOr => "or",
        Key::ImportSupportedFormats => "Supported formats: .txt, .xlsx",
        ...
        Key::StatusInvalidByteHex => "Invalid hex byte value",
        Key::StatusInvalidAddressHex => "Invalid hex address",
        Key::HddImageAttached => "HDD file",
