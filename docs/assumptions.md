...
- Storage workers expose not-ready/disconnected errors on enqueue paths and publish last enqueue errors in device snapshots. Printer PDF jobs additionally publish worker completion or failure through a dedicated completion channel.
