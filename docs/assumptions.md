...
- Storage workers expose not-ready/disconnected errors on enqueue paths and publish last enqueue errors in device snapshots. Native printer jobs publish completion or failure through a dedicated completion channel.
